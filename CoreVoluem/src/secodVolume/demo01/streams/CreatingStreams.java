...
public class CreatingStreams {
    ...
    public static void main(String[] args) throws IOException {
        Path path = Paths.get("E:/学习/JAVA/项目/corejava11/corejava/gutenberg/alice30.txt");
        ...
        Stream<String> wordsAsStreams = Pattern.compile("\\PL+").splitAsStream(contents);
        show("wordsAsStreams",wordsAsStreams);
